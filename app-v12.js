...
const LABELS={results_analysis:"باقة تحليل النتائج",guidance_records:"باقة السجلات الرقمية",all_access:"الباقة الشاملة",presentations:"منصة العروض التقديمية",counselor_plan:"منصة خطة الموجه الطلابي",program_ideas:"منصة أفكار البرامج"};
const PLATFORMS=[
