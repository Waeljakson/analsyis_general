...
const LABELS={results_analysis:"باقة تحليل النتائج",guidance_records:"باقة السجلات الرقمية",all_access:"الباقة الشاملة",presentations:"منصة العروض التقديمية",counselor_plan:"منصة خطة الموجه الطلابي",program_ideas:"منصة أفكار البرامج",messages_library:"مكتبة رسائل أولياء الأمور"};
const PLATFORMS=[
 ...
 {code:"program_ideas",title:"أفكار البرامج",desc:"مكتبة أفكار وبرامج توجيهية قابلة للتخصيص والتنفيذ داخل المدرسة.",icon:`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9 18h6M10 22h4M8.5 15.5a7 7 0 1 1 7 0c-1 .8-1.5 1.5-1.5 2.5h-4c0-1-.5-1.7-1.5-2.5z"/></svg>`,className:"ideas",href:"#",available:false}
];
...
function hasAccess(code){if(code==='messages_library')return hasAnnualPackage();return isAdmin()||hasAllAccess()||activeEntitlements().some(e=>e.product_code===code)}
